...
const MLMPlan = () => {
  ...
  const ranks = [
    { rank: 'Explorer', volume: '$0', match: '5%', levels: 3,  icon: Star },
    { rank: 'Pathfinder', volume: '$10K', match: '6%', levels: 5, icon: Users },
    { rank: 'Strategist', volume: '$50K', match: '7%', levels: 8,  icon: TrendingUp },
    { rank: 'Architect', volume: '$100K', match: '8%', levels: 12,  icon: Award },
    { rank: 'Visionary', volume: '$250K', match: '9%', levels: 18,  icon: Crown },
    { rank: 'Commander', volume: '$1M', match: '10%', levels: 24,  icon: Crown },
    { rank: 'Chancellor', volume: '$10M', match: '11%', levels: 30,  icon: Crown },
    { rank: 'Dominion Partner', volume: '$50M', match: '12%', levels: 36,  icon: Crown },
    { rank: 'Global Guardian', volume: '$100M', match: '13%', levels: '∞',  icon: Crown },
    { rank: 'Empire Founder', volume: '$250M', match: '14%', levels: '∞',  icon: Crown },
    { rank: 'World Sovereign', volume: '$500M', match: '15%', levels: '∞',  icon: Crown },
    { rank: 'Supreme Leader', volume: '$1B', match: '16%', levels: '∞', icon: Crown }
  ];
  ...
  return (
    <section id="mlm-plan" className="py-20 relative">
      <div className="container mx-auto px-4">
        ...
        >
          <h2 className="text-4xl font-bold mb-4">
            <span className="gradient-text">MLM Plan</span>
          </h2>
          <p className="text-gray-400 text-lg max-w-2xl mx-auto">
            Maximize your earnings through our comprehensive multi-level marketing system with multiple income streams
          </p>
        </motion.div>
